...
namespace CStyleExpressions {
    ...
    /// </summary>
   public  class CStyleExpressionEvaluator {
       ...
       // always intialize so function doesn't need to
        ...
        /// </summary>
        public CStyleExpressionEvaluator() {
       ...
       /// </summary>
        ...
        public float Evaluate(string text) {
           ...
           while(index < last) {
               ...
               if (Char.IsWhiteSpace(current)) {
                   ...
                   if (closing != -1) {
                       ...
                       throw new EvaluateException("missing right parentheses");
                   }
                   ...
                   throw new EvaluateException("extra right parentheses");
           ...
           //ithere should only be one value left on value stack
           if (varStack.Count == 1) {
        ...
        private ExpressionToken DoOperation(ExpressionToken op, ExpressionToken ea, ExpressionToken eb) {
            ...
            if (op.Type == ExpressionTokenType.Assignment) {
                ...
                switch (op.Id ) {
                    ...
                    case "=":
                        SetVariable(ea.Id, eb.Value);
                        break;

                    case "+=":
                        SetVariable(ea.Id, ea.Value + eb.Value);
                        break;
       ...
       private string GetOperatorString(ref int start, string text) {
           ...
           //amek sure we don't hit error on mismatched pairs
       ...
       /// <returns>Index of closing parentheses ')' or -1 on failure</returns>
        ...
        public override string ToString() {
            ...
            string appdata = Environment.NewLine + "##### 'C' Style Expressions #####" + Environment.NewLine;

            appdata += header("operators") + Environment.NewLine;
            ...
            appdata += header("unary operators") + Environment.NewLine;
            ...
            appdata += header("functions") + Environment.NewLine;
            ...
            appdata += header("variables") + Environment.NewLine;
